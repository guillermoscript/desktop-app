                    ...
                    <div className="p-6 space-y-6">
                        <form onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <div className="items-center p-6 border-t border-gray-200 rounded-b">
                                <button className="text-gray-700 bg-cyan-600 hover:bg-cyan-700 focus:ring-4 focus:ring-cyan-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center" type="submit">Añadir</button>
                            </div>
                        </form>
                    </div>
                </div>
